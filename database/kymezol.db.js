/**
 * Kymezol (Topical Neuropathy Relief)
 * Database file for the "Kymezol" supplement.
 * Product Line: Digital Lions
 * Protocol: Topical Nerve Pain Relief
 */
DATABASE_CONFIGS["Kymezol"] = {
    ...
    "knowledgeBase": "Kymezol", // Linked to existing KB
    "guaranteeDays": 60,
    "questions": [
        {
            "id": "q-kym-1",
            "text": "Where is the burning or tingling located? Feet, hands, legs? (Diagnostic)",
            "group": "Diagnostic"
        },
        {
            "id": "q-kym-2",
            "text": "Is the sensation more of a burning fire, or electric shocks? (Kymezol Base)",
            "group": "Symptoms"
        },
        {
            "id": "q-kym-3",
