/**
 * Memo Master (Astron)
 * Database file for the "Memo Master" supplement.
 * Product Line: Astron
 * Protocol: Memory Retention & Mental Sharpness
 */
DATABASE_CONFIGS["Memo Master"] = {
    "productLine": "Astron",
    "baseProduct": {
        "name": "Memo Master (Base)",
        "pitch": "This advanced formula supports memory retention and mental sharpness, helping you recall names, dates, and details with greater speed and accuracy.",
        "gender": "any"
    },
    "knowledgeBase": "MemoMaster",
    "guaranteeDays": 60,
    "questions": [
        {
            "id": "q-mm-1",
