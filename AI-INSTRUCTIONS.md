...
Receive Change Request: The user will ask for a bug fix, a new feature, or a data change.

Modify Files: Make the required changes to the component files (.js, .css, .html, or database/*.js).

Determine Change Type: Classify your change into one of three categories:
...
Update package.json: You MUST open package.json, read the current version, increment it based on your change type, and save the file.

Present All Changes: You will present the modified component files and the updated package.json file to the user.
